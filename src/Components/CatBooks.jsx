...
import { AuthContext } from './AuthContext';
  ...
  const renderBooks = () => {
    return books.map((book) => (
      <div key={book._id} className="w-45 rounded-2xl bg-gray-100 flex flex-col items-center justify-centers hover:shadow-lg transition duration-300 flex-shrink-0">
