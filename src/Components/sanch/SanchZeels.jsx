    ...
    <div>
        ...
        <nav>
              <div className="max-w-6xl gap-4 mx-auto flex justify-between items-center transition-all duration-100">
                ...
                >Захиалга</NavLink>
                  <NavLink to='/zeel' className="text-blue-500   rounded-2xl pl-1 pr-1  transition-all duration-100">
                  Гэрээр олгосон ном<Badge badgeContent={zeeltoo} color="primary" className="h-2 sm:h-fit">
