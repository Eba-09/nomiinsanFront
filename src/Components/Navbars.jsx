    ...
    <nav>
      <div className="max-w-6xl mx-auto flex justify-between items-center transition-all duration-100">
        ...
        <div className="hidden md:flex gap-6">
          ...
          <NavLink to="/diplom" className={({ isActive }) => isActive ? "text-blue-500 font-bold lg:border-b-1 md:shadow-none  rounded-2xl pl-1 pr-1  transition-all duration-100" : "hover:text-blue-500 text-gray-700 transition-all duration-100"}>Диплом</NavLink>
          {sanchToken ? (
        <NavLink
        to="/sanchHome"
        className={({ isActive }) =>
      ...
      {isOpen && (
        <div className="md:hidden flex flex-col items-start gap-2 py-1 mt-2 rounded-lg">
          ...
          <NavLink to="/diplom" onClick={() => setIsOpen(false)} className={({ isActive }) => isActive ? "text-blue-500 font-bold transition-all duration-100" : "hover:text-blue-500"}>Дидлом</NavLink>
          {sanchToken ? (
        <NavLink
        to="/sanchHome"
        className={({ isActive }) =>
